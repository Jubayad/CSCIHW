...
// Hint3: A sample story if you are lost can be as simple as "Hello! My name is ____, and I am ____, and my favorite color is ___"
public class Adlibs {
    int age;
    String name, favoriteColor;
    public String story(String name, int age, String favoriteColor) {
        return  "Wasgood! My name is " + name + ", and I am " + age + ", and my favorite color is " + favoriteColor; 
